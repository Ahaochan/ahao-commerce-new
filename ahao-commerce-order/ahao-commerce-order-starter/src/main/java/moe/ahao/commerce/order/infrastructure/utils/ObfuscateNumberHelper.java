package moe.ahao.commerce.order.infrastructure.utils;

/**
 * 数字处理工具类
 */
public class ObfuscateNumberHelper {
    ...
    public static long genNo(long id, int length) {
        // 假设id=15378, length=8
        // 找出8位数的最大值, maxValue=99999999
        long maxValue = (long) Math.pow(10, length) - 1;
        // 找出距离99999999最近的2的平方次数, superScript = loge(99999999) / loge(2) = log2(99999999) = 26
        int superScript = (int) (Math.log(maxValue) / Math.log(2));

        long r = 0;
        // 找出距离99999999最近的2的平方数, sign = 2^26 = 67108864 = 100 0000 0000 0000 0000 0000 0000
        long sign = (long) Math.pow(2, superScript);

        // 做或运算, 保证id变成一个8位的数字
        // id = 15378 = 11 1100 0001 0010
        // id = 15378 | 67108864 = 100 0000 0000 0011 1100 0001 0010
        // id = 67124242         = 100 0000 0000 0011 1100 0001 0010
        id |= sign;
        ...
        // r = 50667776 = 110 000 0101 0010 0001 0000 0000

        // r = 50667776 + (99999999 - 2^26) + 1;
        // r = 83558912
