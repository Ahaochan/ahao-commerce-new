...
import moe.ahao.commerce.aftersale.adapter.mq.*;
...
import static moe.ahao.commerce.common.constants.RocketMqConstant.*;
...
public class ConsumerConfig {
    ...
    public DefaultMQPushConsumer cancelRefundConsumer(CancelOrderRefundListener cancelRefundListener) throws MQClientException {
