...
@Getter
@AllArgsConstructor
public enum OrderExceptionEnum implements BizExceptionEnum<OrderException> {
    /**
     * 正向订单错误码105开头 todo
     */
    ...
    PRODUCT_SKU_CODE_ERROR(105027, "商品%s不存在"),
    ...
    LACK_ITEM_NOT_IN_ORDER(105037, "缺品商品%s并未下单"),
    ...
    PROCESS_PAY_REFUND_CALLBACK_STATUS_NO_IS_NULL(105079, "处理支付退款回调退款状态不能为空"),
    PROCESS_PAY_REFUND_CALLBACK_FEE_NO_IS_NULL(105080, "处理支付退款回调退款金额不能为空"),
    PROCESS_PAY_REFUND_CALLBACK_TOTAL_FEE_NO_IS_NULL(105081, "处理支付退款回调退款总额不能为空"),
    PROCESS_PAY_REFUND_CALLBACK_SIGN_NO_IS_NULL(105082, "处理支付退款回调签名不能为空"),
    PROCESS_PAY_REFUND_CALLBACK_TRADE_NO_IS_NULL(105083, "处理支付退款回调交易号不能为空"),
     ...
     * 通用异常
     */
    COLLECTION_PARAM_CANNOT_BEYOND_MAX_SIZE(108001, "[%s]大小不能超过%s"),
    ENUM_PARAM_MUST_BE_IN_ALLOWABLE_VALUE(108002, "[%s]的取值必须为%s"),
    DELIVERY_TYPE_ERROR(105080, "配送类型错误"),
    ;
    private final int code;
    private final String message;

    public OrderException msg(Object... args) {
        return new OrderException(code, String.format(message, args));
    }
}
