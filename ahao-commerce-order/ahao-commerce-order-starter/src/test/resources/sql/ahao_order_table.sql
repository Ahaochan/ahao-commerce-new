...
CREATE TABLE `after_sale_info` (
  ...
  KEY `idx_after_sale_info_order_id` (`order_id`)
) ENGINE=InnoDB COMMENT='订单售后表';
...
CREATE TABLE `order_amount` (
  ...
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) ,
  KEY `idx_order_amount_order_id` (`order_id`)
) ENGINE=InnoDB COMMENT='订单费用表';
...
CREATE TABLE `order_amount_detail` (
  ...
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) ,
  KEY `idx_order_amount_detail_order_id` (`order_id`)
...
CREATE TABLE `order_delivery_detail` (
  ...
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`),
  KEY `idx_delivery_name` (`receiver_name`),
  KEY `idx_order_delivery_detail_order_id` (`order_id`),
  KEY `idx_receiver_phone` (`receiver_phone`)
) ENGINE = InnoDB COMMENT ='订单配送信息表';
...
CREATE TABLE `order_info` (
  ...
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`),
  UNIQUE KEY `idx_order_info_order_id` (`order_id`),
  KEY `idx_business_identifier` (`business_identifier`),
...
CREATE TABLE `order_operate_log` (
  ...
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`),
  KEY `idx_order_operate_log_order_id` (`order_id`)
...
CREATE TABLE `order_payment_detail` (
  ...
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`),
  KEY `idx_order_payment_detail_order_id` (`order_id`),
  KEY `idx_out_trade_no` (`out_trade_no`),
  KEY `idx_pay_status` (`pay_status`),
  KEY `idx_pay_type` (pay_type)
) ENGINE = InnoDB COMMENT ='订单支付明细表';
...
CREATE TABLE `order_snapshot` (
  ...
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`),
  KEY `idx_order_snapshot_order_id` (`order_id`)
